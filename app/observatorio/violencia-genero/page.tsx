...
Violência de gênero e inteligência territorial na Amazônia Legal        </h1>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="h-[420px] rounded-[2rem] border border-[#d8cab2] bg-white p-8 shadow-sm">
...
<section className="mx-auto max-w-5xl px-6 pb-24">
  ...
  <div className="mb-12 text-center">
    ...
    <h2 className="text-4xl font-black">
      Relações observadas entre expansão extrativista e vulnerabilidade social
    </h2>
  ...
  <div className="rounded-[2rem] border border-[#d8cab2] bg-white p-12 shadow-sm">
    ...
    <div className="flex flex-col items-center gap-4 text-center">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {fontesViolenciaGenero.map((fonte) => (
            <a
              key={fonte.titulo}
              href={fonte.url}
              target="_blank"
...
<section className="mx-auto max-w-6xl px-6 pb-32">
  ...
  <div className="rounded-[2rem] border border-[#d8cab2] bg-[#132719] p-12 text-[#f5ecdb] shadow-xl">
    ...
    <h2 className="max-w-4xl text-4xl font-black leading-tight">
      Infraestrutura pública de comunicação, memória e inteligência territorial na Amazônia
    </h2>
    ...
    <p className="mt-8 max-w-4xl text-xl leading-relaxed text-[#d7cab0]">
      ...
      identificar dinâmicas relacionais entre violência, expansão
      extrativista, desigualdade social e fragilidade institucional
      na Amazônia Legal. 
    </p>
